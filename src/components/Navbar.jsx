    ...
    <div className="bg-white md:p-4 flex flex-col items-center dark:bg-zinc-900 sticky top-0 z-50 shadow-xl">
      <header className="w-full max-w-3xl flex justify-between items-center p-2 bg-white dark:bg-zinc-800 rounded sm:p-4  ">
        ...
        <nav className="flex space-x-4 md:block hidden">
          <Link to="/" className="text-black dark:text-white underline hover:text-green-700 decoration-solid">
            Home
          </Link>
          <Link to="/confess" className="text-black dark:text-white hover:underline hover:text-blue-900">
            Confess
          </Link>
          <Link to="/confessions" className="text-black dark:text-white hover:underline hover:text-blue-900">
            Confessions
          </Link>
        </nav>
